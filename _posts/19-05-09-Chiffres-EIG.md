...
Alors que l'équipe du programme EIG accompagne actuellement une troisième promotion, il nous est apparu intéressant de vous proposer un retour en arrière, et en données, sur son fonctionnement.

**REVOIR L'INTRO : EVALUATION, SITE DE BASTIEN**
...
En trois promotions, le programme s’implante dans l’écosystème de l’innovation publique, comme en témoignent les 500 candidatures reçues lors des différentes promotions pour devenir EIG, ainsi que les 94 défis déposés par des administrations lors des 3 appels à projets.
...
**AJOUTER LE GRAPHIQUE DES POSTES DE DEPENSES**
...
**Les liens avec la recherche représentent environ 1% du budget annuel de chaque promotion**. Ces budgets ont été alloués pour réaliser des études sur le programme EIG avec les laboratoires de recherche [Grico](http://www.grico.fr/) pour EIG 1. Actuellement Clément Mabi, chercheur à l'UTC de Compiègne, suit la promotion 3 dans le cadre ses recherche (pas de financement du programme).

**CLEMENT N'EST PAS FINANCE PAR LE PROGRAMME ?**

### Un programme d’accompagnement qui évolue en fonction des retours des participants au programme
<iframe width="100%" height="500" src="https://data.eig-forever.org/#accompagnement"> </iframe>

**ON NE PARLE PAS DES RETOURS DES EIG DANS CE PARAGRAPHE**
...
Ce retour sur le programme EIG via ces différentes données nous permet de constater que le programme continue de se déployer en répondant à son premier objectif : **associer des agents publics désireux d'innover avec des profils et des compétences rares dans l'administration.** 

Les données utilisées ici permettent de matérialiser les réalisations du programme. Il s'agit d'une première étape de la démarche d'évaluation que mène l'équipe de coordination du programme EIG. Ce travail sur les données du programme EIG fera d'ailleurs l'objet d'une publication en open data prochainement sur [data.gouv.fr](https://www.data.gouv.fr/fr/).
