...
### [Thierry Razanajao](/communaute/2019/thierry-razanajao.html), data scientist ayant des connaissances SIG
...
### [Carine Stolz](/communaute/2019/carine-stolz.html), Géomaticienne / BI 

**Missions principales** : migration des données géographiques, diffusion et valorisation de données (webmapping, web services, API...)

**Compétences** : SIG, ETL, datawarehouse, dataviz, développement d’API
